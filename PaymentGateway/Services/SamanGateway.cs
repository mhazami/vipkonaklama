...
public partial class SamanGateway : System.Web.Services.Protocols.SoapHttpClientProtocol {
    ...
    /// <remarks/>
    public System.IAsyncResult BeginverifyTransaction(string String_1, string String_2, System.AsyncCallback callback, object asyncState) {
    ...
    /// <remarks/>
    public double EndverifyTransaction(System.IAsyncResult asyncResult) {
    ...
    /// <remarks/>
    public System.IAsyncResult BeginverifyTransaction1(string String_1, string String_2, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("verifyTransaction1", new object[] {
                    String_1,
                    String_2}, callback, asyncState);
    }
    
    /// <remarks/>
    public double EndverifyTransaction1(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((double)(results[0]));
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginreverseTransaction(string String_1, string String_2, string Username, string Password, System.AsyncCallback callback, object asyncState) {
    ...
    /// <remarks/>
    public double EndreverseTransaction(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((double)(results[0]));
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginreverseTransaction1(string String_1, string String_2, string Password, double Amount, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("reverseTransaction1", new object[] {
                    String_1,
                    String_2,
                    Password,
    ...
    /// <remarks/>
    public double EndreverseTransaction1(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((double)(results[0]));
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginreverseTransaction2(string String_1, string String_2, string Password, double Amount, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("reverseTransaction2", new object[] {
                    String_1,
                    String_2,
                    Password,
                    Amount}, callback, asyncState);
    ...
    /// <remarks/>
    public ReverseResult EndreverseTransaction2(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((ReverseResult)(results[0]));
    }
