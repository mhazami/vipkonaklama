...
$(document).ready(function () {
    fixMenu();
    navbar();
    $('.r-nav').parent().removeClass("closed");
    ...
    $('.r-collapse').click(function(){
            if ($('.r-nav').hasClass("close-nav")) {
                ...
                $('.r-nav').parent().removeClass("closed");
                $('.r-nav').removeClass("anim-av");
                $('.r-nav').addClass("open-nav");
                $('.r-nav').parent().addClass("opened");
            } else {
                $('.r-nav').removeClass("open-nav");
                $('.r-nav').parent().removeClass("opened");;

                $('.r-nav').addClass("close-nav");
                $('.r-nav').parent().addClass("closed");
                $('.r-nav').addClass("anim-av");
