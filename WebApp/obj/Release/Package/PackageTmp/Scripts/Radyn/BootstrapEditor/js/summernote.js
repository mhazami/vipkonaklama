    ...
    var defaults = {
        ...
        options: {
            ...
            fontNames: [
                ...
                'Tahoma', 'Times New Roman', 'Verdana', 'Yekan', 'Verdana', 'Titr', 'Zar', 'B Nazanin', 'dastnevis',
            ],
    ...
    var Renderer = function () {
        ...
        var tplPopovers = function (lang, options) {
            ...
            var tplImagePopover = function () {
                ...
                var thumbnailButton = tplIconButton(options.iconPrefix + 'fas fa-image', {
        ...
        var tplDialogInfo = {
            image: function (lang, options) {
                ...
                var footer = '<button href="#" class="btn btn-lookup note-image-btn" >' + lang.image.insert + '</button>';
            ...
            link: function (lang, options) {
                var body = '<div class="form-group row-fluid">' +
                    '<input type="button" onclick="showlinkFileManager();" style="cursor: pointer;width: 51%"  class="btn btn-lookup" value="' + lang.link.textToDisplay + '" />' +
                ...
                var footer = '<button href="#" class="btn btn-lookup note-link-btn" >' + lang.link.insert + '</button>';
